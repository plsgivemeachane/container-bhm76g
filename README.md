...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bhm76g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bhm76g.containers.anotherwebservice.com/
...
```
git clone git@github.com:plsgivemeachane/container-bhm76g.git
cd container-bhm76g
```
...
```
docker attach container-bhm76g
```
